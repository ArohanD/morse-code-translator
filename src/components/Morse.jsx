...
const Morse = () => {
    ...
    const [tap_sensitivity, setTap_sensitivity] = useState(0.2);
    const [space_sensitivity, setSpace_sensitivity] = useState(1);
    const [predictions, setPredictions] = useState(blankPredictions);
    const [currentWord, setCurrentWord] = useState('');
    const [letterSensitivity, setLetterSensitivity] = useState(800);
    const [spaceSensitivity, setSpaceSensitivity] = useState(2000);
